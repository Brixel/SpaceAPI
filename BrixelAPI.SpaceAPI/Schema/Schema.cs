...
//    using QuickType;
//
//    var spaceApi = SpaceApi.FromJson(jsonString);

namespace Brixel.Schema;
...
public partial class SpaceApi
{
    public static BrixelAPI.SpaceState.Domain.SpaceStateAggregate.SpaceApi FromJson(string json) => JsonConvert.DeserializeObject<BrixelAPI.SpaceState.Domain.SpaceStateAggregate.SpaceApi>(json, Converter.Settings);
}

public static class Serialize
{
    public static string ToJson(this BrixelAPI.SpaceState.Domain.SpaceStateAggregate.SpaceApi self) => JsonConvert.SerializeObject(self, Converter.Settings);
}
